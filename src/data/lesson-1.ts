...
export const lessonOneSlides = [
  ...
  },
  {
    ...
    title: 'El briefing del pet shop, en versión simple.',
    subtitle: 'La misma estructura aplicada a un caso concreto.',
    time: '85–95 min',
    kind: 'bullets',
    bullets: [
      'Datos del negocio: pet shop con servicio de baño y peluquería.',
      'Localización: Rivera.',
      'Público objetivo: personas con poco tiempo para trasladar a su mascota.',
      'Productos y servicios: baño, peluquería, retiro y entrega a domicilio.',
      'Diferencial: buscamos al perro en casa y lo devolvemos limpio.',
    ],
  },
  {
    id: 'practica',
